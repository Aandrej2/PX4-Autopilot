...
#define BOOTLOADER_DELAY               6000 // 6s
...
#define USBDEVICESTRING                "NUCLEO H753 ZI"
#define USBPRODUCTID                   0x0249

#define BOARD_TYPE                     501
#define OSC_FREQ                       8

#define _FLASH_KBYTES                  (*(uint32_t *)0x1FF1E880) // Flash memory size register address Reference Manual: Page 3292
#define BOARD_FLASH_SECTORS            (15) // Without the zero 0 sector
#define BOARD_FLASH_SIZE               (_FLASH_KBYTES * 1024)

#define USBMFGSTRING                   "NUCLEO H753 ZI"
...
#define SERIAL_BREAK_DETECT_DISABLED   0
...
#  define BOOT_DEVICES_SELECTION SERIAL0_DEV|SERIAL1_DEV|USB0_DEV
#endif

#ifndef BOOT_DEVICES_FILTER_ONUSB
#  define BOOT_DEVICES_FILTER_ONUSB SERIAL0_DEV|SERIAL1_DEV|USB0_DEV
#endif
